...
Source0:        https://github.com/LibreOffice/online/archive/master.tar.gz
...
%{_bindir}/looltool
%{_bindir}/loolconfig
%{_datadir}/loolwsd/discovery.xml
%{_datadir}/loolwsd/favicon.ico
%{_datadir}/loolwsd/robots.txt
%{_datadir}/loolwsd/loleaflet
...
%config(noreplace) %attr(640, lool, root) %{_sysconfdir}/loolwsd/loolwsd.xml
%config %{_sysconfdir}/loolwsd/loolkitconfig.xcu
...
%changelog
* Sun Sep 24 2017 Christian Glombek <christian.glombek@rwth-aachen.de>
